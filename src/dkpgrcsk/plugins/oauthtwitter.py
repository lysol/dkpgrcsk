...
# In Python2.6 the parse_qsl() function is located in the urlparse library.
# In earlier versions it was part of the cgi library.
# Use "import cgi as urlparse" for Python2.5 and earlier, use "import urlparse"
# for Python2.6
# Swapping these two lines is all that is required to make the code compatible
...
# Taken from oauth implementation at:
...
class OAuthApi:
    ...
    def _FetchUrl(self,
        ...
        if http_method == "POST":
            ...
            # Removed the following line due to the fact that OAuth2 request
            # objects do not have this function
            # This does not appear to have any adverse impact on the operation
            # of the toolset
    ...
    def GetFriends(self, options={}):
        ...
        options:
              ...
              See the link below for what options can be passed
              http://apiwiki.twitter.com/
              Twitter-REST-API-Method%3A-statuses%C2%A0friends
    ...
    def GetFriendsIDs(self, options={}):
        ...
        options:
              ...
              See the link below for what options can be passed
              http://apiwiki.twitter.com/
              Twitter-REST-API-Method:-friends%C2%A0ids
    ...
    def GetFollowers(self, options={}):
        ...
        options:
              ...
              See the link below for what options can be passed
              http://apiwiki.twitter.com/
              Twitter-REST-API-Method%3A-statuses%C2%A0followers
    ...
    def GetFollowersIDs(self, options={}):
        ...
        options:
              ...
              See the link below for what options can be passed
              http://apiwiki.twitter.com/
              Twitter-REST-API-Method:-followers%C2%A0ids
    ...
    def GetRelationship(self, user_id=None, screen_name=None, options={}):
        ...
        Args:
        user_id: The user_id of the user to target.  (Source is automatically
        the authenticated user in this case.)

        screen_name: The screen name of the user to target.  (Source is
        automatically the authenticated user in this case.)
    ...
    def ApiCall(self, call, type="GET", parameters={}):
       ...
       Args:
        ...
        try:
            json = self._FetchUrl("https://api.twitter.com/1/" + call + \
          ...
          # servers.  This means something has gone TERRIBLY WRONG somewhere.
